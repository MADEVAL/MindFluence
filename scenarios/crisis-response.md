...
|------|-------------|-------------|
| Social Proof | "Everyone is buying" | "Other companies also had breaches" = deflects blame = outrage |
| Scarcity | "Limited time" | "Only a few users affected" = minimizes harm = worse |
| Confirmation | "You were right" | "We followed industry standards" = defensive = trust killer |
| Authority | "Experts recommend us" | "Our security team is top-tier" = arrogance after failure |

**Crisis communication has its own bias logic. Use only what's listed below.**

---

## THE 6-PART APOLOGY STRUCTURE
...
**WORKS:** "We made a mistake. [Specific thing] happened. It was our fault. Here's exactly what occurred: [facts]."

**Rules:**
- Use active voice. "We failed" > "Mistakes were made." "We broke this" > "This broke."
- State WHAT happened in one clear sentence. No jargon. No euphemisms.
- NEVER use "but" in the acknowledgment. "We made a mistake, but..." = you're about to excuse it.
- Time matters. Acknowledge within hours, not days. Silence = guilt in the public mind.
...
**WORKS:** "I'm sorry. We let you down. You trusted us with [specific thing], and we broke that trust. There is no excuse."
...
**WORKS:** "If you're a [user type] who relied on [feature] for [critical task], we know this [specific impact: cost you time, lost you money, put you at risk]. That's not okay. We know that."

**Rules:**
- Name the specific impact. Not "inconvenience." "Lost revenue." "Missed deadlines." "Wasted hours."
- Put yourself in their position. What would YOU be feeling if this happened to you?
- Use concrete scenarios: "If you had a launch scheduled today, we know this disrupted it."
- Don't overdo it. One genuine paragraph > three paragraphs of groveling.
...
- Root cause, not symptoms. "The server crashed" = symptom. "Our monitoring system had a misconfigured alert threshold that didn't trigger until it was too late" = root cause.
- If a third party was involved, own the decision: "We chose this vendor. We're responsible for that choice."
- NEVER say "this won't happen again" unless you can explain WHY it won't. Empty promises destroy any trust the apology rebuilt.
...
**WORKS:** "Here's what we've already done: [immediate fix]. Here's what's changing permanently: [specific process/team/tool changes]. By [date], [specific change] will be in place. We'll update you on [specific date] with a progress report."
...
- Give affected people a DIRECT path to resolution. Real human contact. Not a bot. Not a form.
- The commitment is where you restore the expectation that "this company is reliable." Specific timeline + specific outcome = tentative trust restored.
- If the crisis was public, the apology must be public. Same channel where the offense occurred.
...
## WHAT NEVER TO DO (crisis anti-patterns)

| Anti-Pattern | Why It's Fatal |
|-------------|----------------|
| "Mistakes were made" (passive voice) | Signals you're hiding from responsibility. |
| "We apologize if..." | The "if" makes it about their perception, not your action. |
| "This is not who we are" | It literally IS who you were when you did the thing. Contradicts reality. |
| "We take this very seriously" | Words without action. Show, don't tell. |
| Deflecting to a third party | You chose the vendor / partner / system. You own it. |
| "Only X users were affected" | Minimizing harm = dismissing the affected. For THEM, it's 100%. |
| Jokes / memes / casual tone | When people are angry, levity = contempt. Read the room. |
| Attorney-written corporate-speak | "We regret any perceived inconvenience" = you're already being sued in the reader's mind. |
| Deleting negative comments | Streisand Effect. Screenshots exist. The deletion IS the story. |
| No follow-up | The apology without the fix = you said words and did nothing. Trust goes negative. |

---

## CRISIS AUDIT: BEFORE PUBLISHING
- [ ] Active voice? "We [verb]" not "[noun] occurred"?
- [ ] Word "sorry" present? Not "regret"?
- [ ] No "if" qualifying the apology?
- [ ] No "but" after the apology?
- [ ] Impact named specifically?
- [ ] Root cause explained in plain language?
- [ ] Immediate fix AND structural fix both stated?
- [ ] Specific timeline for follow-up?
- [ ] Direct contact path for affected people?
- [ ] No joke, no deflection, no minimization?
