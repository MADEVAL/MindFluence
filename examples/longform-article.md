# Example: Long-form Article Intro + Body (excerpt)

**Context:** An article about why most productivity systems fail, promoting a minimalist productivity course.
**Request:** "Write the article intro and first major section. Audience: knowledge workers overwhelmed by tools."

---

[TONE: expert-calm × rebel-edgy]
[BIASES ENGAGED: Availability Heuristic (#6), Loss Aversion (#5), Framing (#3), Anchoring (#2), Cognitive Dissonance (#8), Confirmation Bias (#7), Authority (#4), Survivorship Bias (#9), Bias Blind Spot (#19)]
[TARGET ACTION: Read full article → subscribe to newsletter → eventually buy course]

---

# You Don't Have a Productivity Problem. You Have a Complexity Problem.
...
The average knowledge worker now uses 6 different tools just to manage their daily tasks. Calendar in one app. Tasks in another. Notes in a third. Communication in Slack. Documentation in Notion. Files in Drive. Six tools. Six notification streams. Six mental models to maintain.

Every new tool promises to be the last one you'll ever need. And every new tool adds another layer of complexity that demands another tool to manage.

This isn't a productivity crisis. It's a complexity crisis dressed in productivity's clothes. And the solution isn't another app. It's a principle so simple it's almost embarrassing.

---

## The $10,000 Lesson I Learned by Deleting Everything
...
Monday morning, I opened a single text file and wrote:
...
$50/hour × 2.5 hours/day × 250 working days = **$31,250 per year in lost cognitive output.**

Per person.

You're not bad at productivity. You're operating a brain designed for the savanna inside an environment designed by software companies who profit from your attention, not your output.

The fix isn't another tool. It's a filter.

---

[... article continues with the "Three-Item Method" framework, case studies, and course pitch ...]
...
- **Survivorship Bias (subtext):** The author's story (hit a wall → deleted everything → succeeded) is a survivorship narrative. It works because the author acknowledges the failure FIRST. The vulnerability (Bias Blind Spot) makes the success story credible rather than boastful.
